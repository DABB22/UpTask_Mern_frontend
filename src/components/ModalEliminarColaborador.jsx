...
const ModalEliminarColaborador = () => {
    ...
    const { modalEliminarColaborador, handleModalEliminarColaborador, eliminarColaborador, alerta } = useProyectos()
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start mt-6">
                                ...
                                {alerta.msg && <Alerta alerta={alerta}/>}
                                    ...
                                    <Dialog.Title 
                                        as="h3" className="text-lg leading-6 font-bold text-gray-900 mb-3"
                                    >
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500">
                                            Realmente desea eliminar el colaborador?
                                        </p>
                                    </div>
